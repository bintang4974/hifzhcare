...
@section('breadcrumb', 'Super Admin / Pesantren / Tambah')
...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Tambah Pesantren Baru</h1>
                <p class="text-gray-600 mt-1">Daftarkan pesantren baru ke dalam sistem</p>
            </div>
        ...
        <form action="{{ route('superadmin.pesantrens.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_santri" value="{{ old('max_santri') }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="established_year" value="{{ old('established_year') }}" min="1900"
                            max="{{ date('Y') }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="3" required
                            ...
                            placeholder="Masukkan alamat lengkap pesantren">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="4"
                            ...
                            placeholder="Deskripsi singkat tentang pesantren, visi misi, program unggulan, dll">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="activated_at" value="{{ old('activated_at') }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="subscription_expired_at" value="{{ old('subscription_expired_at') }}"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-800">
                            <strong>Informasi:</strong> Setelah pesantren dibuat, Anda perlu membuat akun admin untuk
                            pesantren tersebut
                            agar mereka dapat mengelola data santri, ustadz, dan hafalan.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-4">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>Simpan Pesantren
                </button>
            </div>
        </form>
    </div>
...
@push('scripts')
    <script>
        ...
        // Auto-format phone numbers (remove non-numeric)
        document.querySelectorAll('input[type="tel"]').forEach(input => {
            input.addEventListener('input', function(e) {
                // Allow parentheses, spaces, and dashes for phone formatting
