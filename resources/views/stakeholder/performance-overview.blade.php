...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div
                class="bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 rounded-3xl p-10 text-white shadow-2xl">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <div class="mt-6 p-4 bg-purple-50 rounded-lg">
                        <p class="text-sm text-purple-800">
                            ...
                            <span
                                class="text-2xl font-bold text-purple-600">{{ $performance['operational_score'] }}/100</span>
                        </p>
                    </div>
                </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Avg
                                    Progress
                                </th>
